 ...
 * @author bche
 */
public class PopulateApplicationDirectoryPortlet
    ...
    public PortletType getPortletType() {
        return (PortletType)AppPortletType.retrievePortletTypeForPortlet(ApplicationDirectoryPortlet.BASE_DATA_OBJECT_TYPE);
    }
