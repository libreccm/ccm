 ...
 * @author bche
 */
public class PopulatePortalNavigatorPortlet
    ...
    public PortletType getPortletType() {
        return (PortletType)AppPortletType.retrievePortletTypeForPortlet(PortalNavigatorPortlet.BASE_DATA_OBJECT_TYPE);
    }
