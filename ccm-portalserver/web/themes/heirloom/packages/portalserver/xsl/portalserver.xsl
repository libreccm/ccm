        ...
        <table align="right" style="margin: 0; border: 0; padding: 0;">
          <tr>
            <td style="margin: 0; border: 0; padding: 0; padding-right: 18px;">
             ...
             <!--     <td class="global-link-icon"><a href="/assets/help/toc_main.html"><img src="{$internal-theme}/images/lifesaver.png" height="18" width="21"/></a></td> 
            ...
            <td class="global-link-icon">
              <a href="{../portalserver:global/bebop:link[@class = 'signoutLink']/@href}">
                 <img src="{$internal-theme}/images/lock.png" 
                      height="18" width="14"/>
              </a>
            </td>
            <td class="global-link">
               <a href="{../portalserver:global/bebop:link[@class = 'signoutLink']/@href}">Sign out</a>
            </td>
  ...
  <a href="{@href}" onclick="{@onclick}">
    <img border="0">
      ...
      <xsl:attribute name="src">
        <xsl:value-of select="//@assets"/>{$internal-theme}/images/download.gif</xsl:attribute>
    </img>
  </a>
</xsl:template>
