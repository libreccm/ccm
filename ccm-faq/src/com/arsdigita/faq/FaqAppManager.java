 ...
 * @version $Id$
 */
public class FaqAppManager extends AbstractApplicationManager<Faq> {

    public Class<Faq> getApplication() {
        return Faq.class;
    }
    ...
    public ApplicationInstanceAwareContainer getApplicationAdminForm() {
        ...
        panel.add(new Label(new GlobalizedMessage("faq.ui.admin.no_settings", "com.arsdigita.faq.FaqResources")));
