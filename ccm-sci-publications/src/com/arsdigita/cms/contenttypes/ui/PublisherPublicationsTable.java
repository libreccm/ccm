...
public class PublisherPublicationsTable extends Table {
    ...
    public PublisherPublicationsTable(final ItemSelectionModel itemModel) {
        super();
    ...
    private class ModelBuilder extends LockableImpl implements TableModelBuilder {
        ...
        public TableModel makeModel(final Table table, final PageState state) {
            ...
            final Publisher publisher = (Publisher) itemModel.getSelectedItem(state);

            return new Model(table, state, publisher);
        }
    ...
    private class Model implements TableModel {
        ...
        public Model(final Table table, final PageState state, final Publisher publisher) {
            this.table = table;
            publications = publisher.getPublications();
        }
