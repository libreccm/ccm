...
/**
 * The generic navigation model just returns the
 * root category for an application, or, if none
 * is set returns the default root category.
 */
public class GenericNavigationModel extends AbstractNavigationModel {
    ...
    protected Category loadRootCategory() {
        ...
        if (cat == null) {
            cat = Navigation.getConfig().getDefaultCategoryRoot();
        }
