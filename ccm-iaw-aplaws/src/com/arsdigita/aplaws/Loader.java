...
public class Loader extends PackageLoader {
    ...
    private static final String[] categoryFiles = new String[] {
        "WEB-INF/aplaws/iaw-nav-domain-1.00.xml"
      , "WEB-INF/aplaws/iaw-nav-hierarchy-1.00.xml"
    };
...
//  }
    ...
    public void registerNavigationTemplates() {
        ...
        template = Template.create(
            "IAW AtoZ paginator",
            "IAW AtoZ paginator index page",
            "/packages/navigation/templates/iaw-atoz.jsp");

        template = Template.create(
            "IAW Default",
            "IAW default index page",
            "/packages/navigation/templates/iaw-default.jsp");

        template = Template.create(
            "IAW Portalseite",
            "IAW Portal Page",
            "/packages/navigation/templates/iaw-portal.jsp");

        template = Template.create(
            "IAW Recent",
            "IAW reverse order page",
            "/packages/navigation/templates/iaw-recent.jsp");

        template = Template.create(
            "IAW Welcome Page",
            "IAW Welcome Page for navigation",
            "/packages/navigation/templates/iaw-welcome.jsp");
