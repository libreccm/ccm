...
<xsl:import href="FAQItem.xsl"/>
<xsl:import href="GlossaryItem.xsl"/>
...
<xsl:template match="cms:item[objectType='com.arsdigita.cms.contenttypes.FAQItem' and not(@useContext = 'itemAdminSummary')]">
<xsl:call-template name="CT_FAQItem_graphics"/>
</xsl:template>
<xsl:template match="cms:item[objectType='com.arsdigita.cms.contenttypes.GlossaryItem' and not(@useContext = 'itemAdminSummary')]">
<xsl:call-template name="CT_GlossaryItem_graphics"/>
</xsl:template>
...
<xsl:call-template name="CT_Form_graphics"/>
</xsl:template>
