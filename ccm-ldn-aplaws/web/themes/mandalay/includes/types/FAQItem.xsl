...
<xsl:stylesheet 
  ...
  <!-- DE Listenansicht -->
  <!-- EN List view -->
  <xsl:template name="CT_FAQItem_List" match="nav:item[nav:attribute[@name='objectType'] = 'com.arsdigita.cms.contenttypes.FAQItem']" mode="list_view">
  ...
  <xsl:template name="CT_FAQItem_Link" match="*/cms:item/links[targetItem/objectType = 'com.arsdigita.cms.contenttypes.FAQItem']" mode="link_view">
