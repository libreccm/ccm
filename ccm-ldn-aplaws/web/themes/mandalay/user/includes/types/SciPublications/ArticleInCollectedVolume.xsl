...
<xsl:stylesheet
    ...
    <xsl:template name="CT_ArticleInCollectedVolume_graphics"
        ...
        <xsl:variable name="setAbstract">
            <xsl:call-template name="mandalay:getSetting">
                <xsl:with-param name="module" select="'SciPublications'" />
                <xsl:with-param name="setting" select="'articleInCollectedVolume/setAbstract'" />
                <xsl:with-param name="default" select="'true'" />
            </xsl:call-template>
        </xsl:variable>
        ...
        <xsl:variable name="setAuthors">
            <xsl:call-template name="mandalay:getSetting">
                <xsl:with-param name="module" select="'SciPublications'" />
                <xsl:with-param name="setting" select="'articleInCollectedVolume/setAuthors'" />
                <xsl:with-param name="default" select="'true'" />
            </xsl:call-template>
        </xsl:variable>
        <xsl:variable name="setChapter">
            <xsl:call-template name="mandalay:getSetting">
                <xsl:with-param name="module" select="'SciPublications'" />
                <xsl:with-param name="setting" select="'articleInCollectedVolume/setChapter'" />
                <xsl:with-param name="default" select="'true'" />
            </xsl:call-template>
        </xsl:variable>
        <xsl:variable name="setCollectedVolume">
            <xsl:call-template name="mandalay:getSetting">
                <xsl:with-param name="module" select="'SciPublications'" />
                <xsl:with-param name="setting" select="'articleInCollectedVolume/setCollectedVolume'" />
                <xsl:with-param name="default" select="'true'" />
            </xsl:call-template>
        </xsl:variable>
        <xsl:variable name="setIsbn">
            <xsl:call-template name="mandalay:getSetting">
                <xsl:with-param name="module" select="'SciPublications'" />
                <xsl:with-param name="setting" select="'articleInCollectedVolume/setIsbn'" />
                <xsl:with-param name="default" select="'true'" />
            </xsl:call-template>
        </xsl:variable>
        <xsl:variable name="setLanguageOfPublication">
            <xsl:call-template name="mandalay:getSetting">
                <xsl:with-param name="module" select="'SciPublications'" />
                <xsl:with-param name="setting" select="'articleInCollectedVolume/setLanguageOfPublication'" />
                <xsl:with-param name="default" select="'true'" />
            </xsl:call-template>
        </xsl:variable>
        <xsl:variable name="setMisc">
            <xsl:call-template name="mandalay:getSetting">
                <xsl:with-param name="module" select="'SciPublications'" />
                <xsl:with-param name="setting" select="'articleInCollectedVolume/setMisc'" />
                <xsl:with-param name="default" select="'true'" />
            </xsl:call-template>
        </xsl:variable>
        <xsl:variable name="setPages">
            <xsl:call-template name="mandalay:getSetting">
                <xsl:with-param name="module" select="'SciPublications'" />
                <xsl:with-param name="setting" select="'articleInCollectedVolume/setPages'" />
                <xsl:with-param name="default" select="'true'" />
            </xsl:call-template>
        </xsl:variable>
        <xsl:variable name="setPublisher">
            <xsl:call-template name="mandalay:getSetting">
                <xsl:with-param name="module" select="'SciPublications'" />
                <xsl:with-param name="setting" select="'articleInCollectedVolume/setPublisher'" />
                <xsl:with-param name="default" select="'true'" />
            </xsl:call-template>
        </xsl:variable>
        <xsl:variable name="setReviewed">
            <xsl:call-template name="mandalay:getSetting">
                <xsl:with-param name="module" select="'SciPublications'" />
                <xsl:with-param name="setting" select="'articleInCollectedVolume/setReviewed'" />
                <xsl:with-param name="default" select="'true'" />
            </xsl:call-template>
        </xsl:variable>
        <xsl:variable name="setSeries">
            <xsl:call-template name="mandalay:getSetting">
                <xsl:with-param name="module" select="'SciPublications'" />
                <xsl:with-param name="setting" select="'articleInCollectedVolume/setSeries'" />
                <xsl:with-param name="default" select="'true'" />
            </xsl:call-template>
        </xsl:variable>
        <xsl:variable name="setSeriesLink">
            <xsl:call-template name="mandalay:getSetting">
                <xsl:with-param name="module" select="'SciPublications'" />
                <xsl:with-param name="setting" select="'articleInCollectedVolume/setSeriesLink'" />
                <xsl:with-param name="default" select="'true'" />
            </xsl:call-template>
        </xsl:variable>
        <xsl:variable name="setSeriesVolume">
            <xsl:call-template name="mandalay:getSetting">
                <xsl:with-param name="module" select="'SciPublications'" />
                <xsl:with-param name="setting" select="'articleInCollectedVolume/setSeriesVolume'" />
                <xsl:with-param name="default" select="'true'" />
            </xsl:call-template>
        </xsl:variable>
        <xsl:variable name="setUrl">
            <xsl:call-template name="mandalay:getSetting">
                <xsl:with-param name="module" select="'SciPublications'" />
                <xsl:with-param name="setting" select="'articleInCollectedVolume/setUrl'" />
                <xsl:with-param name="default" select="'true'" />
            </xsl:call-template>
        </xsl:variable>
        <xsl:variable name="setYear">
            <xsl:call-template name="mandalay:getSetting">
                <xsl:with-param name="module" select="'SciPublications'" />
                <xsl:with-param name="setting" select="'articleInCollectedVolume/setYear'" />
                <xsl:with-param name="default" select="'true'" />
            </xsl:call-template>
        </xsl:variable>
        <xsl:variable name="setYearFirstPublished">
            <xsl:call-template name="mandalay:getSetting">
                <xsl:with-param name="module" select="'SciPublications'" />
                <xsl:with-param name="setting" select="'articleInCollectedVolume/setYearFirstPublished'" />
                <xsl:with-param name="default" select="'true'" />
            </xsl:call-template>
        </xsl:variable>
            ...
            <dl>
                    ...
                    <xsl:call-template name="scipublicationsAuthors">
                        ...
                        <xsl:with-param name="authorText">
                            <xsl:call-template name="mandalay:getStaticText">
                                <xsl:with-param name="module" select="'SciPublications'" />
                                <xsl:with-param name="id" select="'articleInCollectedVolume/author'" />
                            </xsl:call-template>
                        </xsl:with-param>
                        <xsl:with-param name="authorsText">
                            <xsl:call-template name="mandalay:getStaticText">
                                <xsl:with-param name="module" select="'SciPublications'" />
                                <xsl:with-param name="id" select="'articleInCollectedVolume/authors'" />
                            </xsl:call-template>
                        </xsl:with-param>
                    </xsl:call-template>
                </xsl:if>
                ...
                <xsl:if test="($setYear = 'true') and (string-length(./yearOfPublication) &gt; 0)">
                    <dt>
                        <xsl:call-template name="mandalay:getStaticText">
                            <xsl:with-param name="module" select="'SciPublications'" />
                            <xsl:with-param name="id" select="'articleInCollectedVolume/year'" />
                        </xsl:call-template>
                    </dt>
                    <dd>
                ...
                <xsl:if test="($setYearFirstPublished = 'true') and (string-length(./yearFirstPublished) &gt; 0)">
                    <dt>
                        <xsl:call-template name="mandalay:getStaticText">
                            <xsl:with-param name="module" select="'SciPublications'"/>
                            <xsl:with-param name="id" select="'articleInCollectedVolume/yearFirstPublished'"/>
                        </xsl:call-template>
                    </dt>
                    <dd>
                ...
                <xsl:if test="($setLanguageOfPublication = 'true') and (string-length(./languageOfPublication) &gt; 0)">
                    <dt>
                        <xsl:call-template name="mandalay:getStaticText">
                            <xsl:with-param name="module" select="'SciPublications'" />
                            <xsl:with-param name="id" select="'articleInCollectedVolume/languageOfPublication'" />
                        </xsl:call-template>
                    </dt>
                    <dd>
                ...
                <xsl:if test="($setIsbn = 'true') and (string-length(./isbn) &gt; 0)">
                    <dt>
                        <xsl:call-template name="mandalay:getStaticText">
                            <xsl:with-param name="module" select="'SciPublications'" />
                            <xsl:with-param name="id" select="'articleInCollectedVolume/isbn'" />
                        </xsl:call-template>
                    </dt>
                    <dd>
                ...
                <xsl:if test="($setUrl = 'true') and (string-length(./url) &gt; 0)">
                    <dt>
                        <xsl:call-template name="mandalay:getStaticText">
                            <xsl:with-param name="module" select="'SciPublications'" />
                            <xsl:with-param name="id" select="'articleInCollectedVolume/url'" />
                        </xsl:call-template>
                    </dt>
                    <dd>
                        <a>
                ...
                <xsl:if test="($setChapter = 'true') and (string-length(./chapter) &gt; 0)">
                    <dt>
                        <xsl:call-template name="mandalay:getStaticText">
                            <xsl:with-param name="module" select="'SciPublications'" />
                            <xsl:with-param name="id" select="'articleInCollectedVolume/chapter'" />
                        </xsl:call-template>
                    </dt>
                    <dd>
                ...
                <xsl:if test="($setCollectedVolume = 'true') and (string-length(./collectedVolume) &gt; 0)">

                    <dt>
                        <xsl:call-template name="mandalay:getStaticText">
                            <xsl:with-param name="module" select="'SciPublications'" />
                            <xsl:with-param name="id" select="'articleInCollectedVolume/collectedVolume'" />
                        </xsl:call-template>
                    </dt>
                    <dd>
                        <xsl:for-each select="./collectedVolume">
                ...
                <xsl:if test="($setPages = 'true') and (string-length(./pagesFrom) &gt; 0)">
                    <dt>
                        <xsl:call-template name="mandalay:getStaticText">
                            <xsl:with-param name="module" select="'SciPublications'" />
                            <xsl:with-param name="id" select="'articleInCollectedVolume/pages'" />
                        </xsl:call-template>
                    </dt>
                    <dd>
                        ...
                        <xsl:if test="string-length(./pagesTo) &gt; 0">
                            <xsl:call-template name="mandalay:getStaticText">
                                <xsl:with-param name="module" select="'SciPublications'" />
                                <xsl:with-param name="id" select="'articleInCollectedVolume/pagesSeparator'" />
                            </xsl:call-template>
                ...
                <xsl:if test="($setReviewed = 'true') and (string-length(./reviewed) &gt; 0) and (./reviewed = 'true')">
                    ...
                    <dt>
                        <xsl:call-template name="mandalay:getStaticText">
                            <xsl:with-param name="module" select="'SciPublications'" />
                            <xsl:with-param name="id" select="'articleInCollectedVolume/reviewed'" />
                        </xsl:call-template>
                    </dt>
                    <dd>&nbsp;</dd>
                </xsl:if>
                <xsl:if test="($setSeries = 'true') and (string-length(./series/series/title) &gt; 0)">
                    <dt>
                        <xsl:call-template name="mandalay:getStaticText">
                            <xsl:with-param name="module" select="'SciPublications'" />
                            <xsl:with-param name="id" select="'articleInCollectedVolume/series'" />
                        </xsl:call-template>
                    </dt>
                    <dd>
                        <xsl:choose>
            ...
            <xsl:if test="($setAbstract = 'true') and (string-length(./abstract) &gt; 0)">
                <div class="publicationAbstract">
                    <h3>
                        <xsl:call-template name="mandalay:getStaticText">
                            <xsl:with-param name="module" select="'SciPublications'" />
                            <xsl:with-param name="id" select="'articleInCollectedVolume/abstract'" />
                        </xsl:call-template>
                    </h3>
                    <div class="abstract">
    ...
    <xsl:template name="CT_ArticleInCollectedVolume_List"
        ...
        <!--
            Process the authors of the collected volume
        -->
        <xsl:variable name="collectedVolumeAuthors">
            <xsl:for-each select="./collectedVolume/authors/author">
                <xsl:sort select="./@order" data-type="number" />
                <xsl:apply-templates select="document(concat($theme-prefix, '/settings/', $formatDefFile))/bibrefFormat/bibrefAuthorFormat">
        ...
        <!-- Process the publisher of the collected volume -->
        <xsl:variable name="collectedVolumePublisher">
            <xsl:for-each select="./collectedVolume/publisher">
        ...
        <xsl:variable name="collectedVolume">
            ...
            <xsl:apply-templates select="document(concat($theme-prefix, '/settings/', $formatDefFile))/bibrefFormat/bibrefCollectedVolumeFormat">
                ...
                <xsl:with-param name="edition" select="./collectedVolume/edition" />
                <xsl:with-param name="isbn" select="./collectedVolume/isbn" />
                <xsl:with-param name="numberOfPages" select="./collectedVolume/numberofpages" />
                <xsl:with-param name="numberOfVolumes" select="./collectedVolume/numberOfVolumes" />
                <xsl:with-param name="publisher" select="normalize-space($collectedVolumePublisher)" />
                <xsl:with-param name="reviewed" select="./collectedVolume/reviewed" />
                <xsl:with-param name="title" select="./collectedVolume/title" />
                <xsl:with-param name="volume" select="./collectedVolume/volume" />
        ...
        -->
        <xsl:apply-templates select="document(concat($theme-prefix, '/settings/', $formatDefFile))/bibrefFormat/bibrefArticleInCollectedVolumeFormat">
