...
<!-- run this on combined-hierlgcl-and-anav.xml -->
  ...
  <xsl:template match="combined">
    ...
    <terms:hierarchy xmlns:terms="http://xmlns.redhat.com/london/terms/1.0">
      ...
      <xsl:for-each select="./hierarchy-lgcl/terms:hierarchy/terms:orderedPair">
        ...
        <xsl:if test="not(/combined/hierarchy-anav/terms:hierarchy/terms:orderedPair[terms:source/terms:term/@id = $sourceId and terms:destination/terms:term/@id = $destinationId])">
