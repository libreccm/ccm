...
import com.arsdigita.formbuilder.ui.editors.TextFieldForm;
 ...
 * TextFieldForm to remove the HTML name that we don't want to appear in
 * the Simple Survey application.
 *
 * @author <a href="mailto:pmarklun@arsdigita.com">Peter Marklund</a>
 * @version $Id: OneLineWidgetForm.java 755 2005-09-02 13:42:47Z sskracic $
 */
public class OneLineWidgetForm extends TextFieldForm {

    public OneLineWidgetForm(String name,
