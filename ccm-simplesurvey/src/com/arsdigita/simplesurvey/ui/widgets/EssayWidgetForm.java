...
import com.arsdigita.formbuilder.ui.editors.TextAreaForm;
 ...
 * TextAreaForm to remove the HTML name that we don't want to appear in
 * the Simple Survey application.
 *
 * @author <a href="mailto:pmarklun@arsdigita.com">Peter Marklund</a>
 * @version $Id: EssayWidgetForm.java 755 2005-09-02 13:42:47Z sskracic $
 */
public class EssayWidgetForm extends TextAreaForm {

    public EssayWidgetForm(String name,
