...
/**
 * Displays the non-preferred terms (synonyms) for the current term.
 * 
 * @author <a href="https://sourceforge.net/users/terry_permeance/">terry_permeance</a>
 */
public class NonPreferredTermListing extends AbstractDomainObjectList {
    ...
    public NonPreferredTermListing(DomainObjectParameter domain,
                              DomainObjectParameter term) {
        super("nonPreferredTermListing",
              Terms.XML_PREFIX,
              Terms.XML_NS);
        ...
        addDomainObjectActionListener(
            ...
            new DomainObjectActionListener() {
                public void actionPerformed(DomainObjectActionEvent e) {
                    ...
                    otherTerm.removePreferredTerm(term);
                }
            });
    }
    ...
    protected DomainCollection getDomainObjects(PageState state) {
        Term term = (Term)state.getValue(m_term);
        DomainCollection terms = term.getNonPreferredTerms();
