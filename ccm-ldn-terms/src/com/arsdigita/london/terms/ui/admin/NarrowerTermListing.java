...
public class NarrowerTermListing extends AbstractDomainObjectList {
    ...
    public NarrowerTermListing(DomainObjectParameter domain,
                               DomainObjectParameter term) {
        super("narrowerTermListing",
              Terms.XML_PREFIX,
              Terms.XML_NS);
        ...
        addDomainObjectActionListener(
            ...
            new DomainObjectActionListener() {
                public void actionPerformed(DomainObjectActionEvent e) {
                    ...
                    term.removeNarrowerTerm(otherTerm);
                }
            });
    }
    ...
    protected DomainCollection getDomainObjects(PageState state) {
        Term term = (Term)state.getValue(m_term);
        DomainCollection terms = term.getNarrowerTerms();
