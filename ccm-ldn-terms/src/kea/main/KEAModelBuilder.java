...
public class KEAModelBuilder implements OptionHandler {
    ...
    private static Logger s_log = Logger.getLogger(KEAModelBuilder.class);
    ...
    public void buildModel(Hashtable stems) throws Exception {
        ...
        s_log.debug("-- Reading the Documents... ");
        ...
        while (elem.hasMoreElements()) {
            ...
            try {
                ...
                if (m_debug) {
                    s_log.debug("Can't find document for stem " + str + ".");
                }
            ...
            try {
                ...
                if (m_debug) {
                    s_log.debug("Can't find keyphrases for stem " + str + ".");
                }
    ...
    public void saveModel() throws Exception {
        ...
        BufferedOutputStream bos = new BufferedOutputStream(new FileOutputStream(m_modelName + ".xml"));
        XStream xstream = new XStream(new DomDriver());
        bos.write(xstream.toXML(m_KEAFilter).getBytes());
        bos.flush();
        bos.close();
    }
    ...
    public static void main(String[] ops) {
        ...
        try {
            kmb.setOptions(ops);
            s_log.debug("Building model with options: ");
