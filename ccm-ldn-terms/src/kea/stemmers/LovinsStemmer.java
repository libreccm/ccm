...
public class LovinsStemmer extends Stemmer implements Serializable {
    ...
    private static final Logger logger = Logger.getLogger(LovinsStemmer.class);
    /**
     *
     */
                ...
                if (conditionCode != null) {
                    switch (conditionCode.charAt(0)) {
                        ...
                        case 'E':
                            ...
                            break;
                        case 'F':
                            if ((length - el > 2) && (word.charAt(length - el
                                                                  - 1) != 'e')) {
                                return word.substring(0, length - el);
                            }
                            break;
                        ...
                        case 'X':
                            if ((word.charAt(length - el - 1) == 'l')
                                || (word.charAt(length - el - 1) == 'i')
                                || ((length - el > 2) && (word.charAt(length
                                                                      - el - 1)
                                                          == 'e') && (word.
                                                                      charAt(length
                                                                             - el
                            ...
                            if (m_CompMode) {
                                if (((length - el == 3) && (!((word.charAt(length
                                                              ...
                                                              && (word.charAt(
                                                                  ...
                                                                  - 3) == 'm'))))
                                    || ((length - el > 3)
                                        && (!((word.charAt(length - el - 1)
                                               == 't') && (word.charAt(length
                                                                       - el - 2)
                                                           == 's') && (word.
                                                                       charAt(
                                                                       length
                                                                       - el - 3)
                                                                       == 'y')
                                              && (word.charAt(length - el - 4)
                                                  == 'r'))))) {
                                    return word.substring(0, length - el);
                                }
                            } else {
                                if ((length - el > 2) && (!((word.charAt(length
                                                                         - el
                                                                         - 1)
                                                             == 't') && (word.
                                                                         charAt(
    ...
    private String recodeEnding(String word) {
        ...
        // Rule 1
        if (word.endsWith("bb") || word.endsWith("dd") || word.endsWith("gg") || word.
                endsWith("ll") || word.endsWith("mm") || word.endsWith("nn") || word.
                endsWith("pp") || word.endsWith("rr") || word.endsWith("ss") || word.
                endsWith("tt")) {
        ...
        if (word.endsWith("her")) {
            if ((lastPos - 3 < 0) || ((word.charAt(lastPos - 3) != 'p')
