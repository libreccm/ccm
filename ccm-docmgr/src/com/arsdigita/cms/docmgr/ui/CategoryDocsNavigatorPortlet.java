...
public class CategoryDocsNavigatorPortlet extends AppPortlet 
    ...
    public CategoryDocsNavigatorPortlet(DataObject dataObject) {
        super(dataObject);
    ...
    protected AbstractPortletRenderer doGetPortletRenderer() {
        return new CategoryDocsNavigatorPortletRenderer(this);
    }

    class CategoryDocsNavigatorPortletRenderer extends AbstractPortletRenderer
        implements DMConstants {
        private CategoryDocsNavigatorPortlet m_portlet;
        
        public CategoryDocsNavigatorPortletRenderer
            (CategoryDocsNavigatorPortlet docsPortlet) {
...
// 	    Iterator i = m_rootCategory.getChildCategories().iterator();
//             while(i.hasNext()) {
