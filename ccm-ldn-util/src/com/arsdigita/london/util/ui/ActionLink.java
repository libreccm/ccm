...
/**
 * A simple subclass of the bebop action link that
 * sets the actionLink class attribute to ensure
 * expected styling is picked up
 */
public class ActionLink extends com.arsdigita.bebop.ActionLink {
