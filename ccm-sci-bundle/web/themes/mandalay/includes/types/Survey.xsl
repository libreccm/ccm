...
<xsl:stylesheet 
  ...
  <xsl:template name="CT_Survey_graphics" match="cms:item[objectType='com.arsdigita.cms.contenttypes.Survey']" mode="detailed_view">
    ...
    <div id="mainBody">
      ...
      <form>
        ...
        -->
        <!-- EN 
          Processing components in order of apperance
          Skipping all com.arsdigita.formabuilder.Widget, because the information are redundant
        -->
  ...
  <!-- DE Listenansicht -->
  <!-- EN List view -->
  <xsl:template name="CT_Survey_List" match="nav:item[nav:attribute[@name='objectType'] = 'com.arsdigita.cms.contenttypes.Survey']" mode="list_view">
  ...
  <xsl:template name="CT_Survey_Link" match="*/cms:item/links[targetItem/objectType = 'com.arsdigita.cms.contenttypes.Survey']" mode="link_view">
