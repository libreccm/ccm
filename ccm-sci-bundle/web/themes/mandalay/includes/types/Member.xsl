...
<xsl:stylesheet 
  ...
  <!-- DE Listenansicht -->
  <!-- EN List view -->
  <xsl:template  name="CT_Member_List" match="nav:item[nav:attribute[@name='objectType'] = 'com.arsdigita.cms.contenttypes.Member']" mode="list_view">
  ...
  <xsl:template name="CT_Member_Link" match="*/cms:item/links[targetItem/objectType = 'com.arsdigita.cms.contenttypes.Member']" mode="link_view">
