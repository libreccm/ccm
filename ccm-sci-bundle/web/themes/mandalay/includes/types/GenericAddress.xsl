...
<xsl:stylesheet 
  ...
  <!-- DE Listenansicht -->
  <!-- EN List view -->
  <xsl:template  name="CT_GenericAddress_List" match="nav:item[nav:attribute[@name='objectType'] = 'com.arsdigita.cms.contenttypes.GenericAddress']" mode="list_view">
  ...
  <xsl:template name="CT_GenericAddress_Link" match="*/cms:item/links[targetItem/objectType = 'com.arsdigita.cms.contenttypes.GenericAddress']" mode="link_view">
