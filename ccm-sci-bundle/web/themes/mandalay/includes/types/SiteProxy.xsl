...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" 
  ...
  <!-- DE Listenansicht -->
  <!-- EN List view -->
  <xsl:template  name="CT_SiteProxy_List" match="nav:item[nav:attribute[@name='objectType'] = 'com.arsdigita.cms.contenttypes.SiteProxy']" mode="list_view">
  ...
  <xsl:template name="CT_SiteProxy_Link" match="*/cms:item/links[targetItem/objectType = 'com.arsdigita.cms.contenttypes.SiteProxy']" mode="link_view">
  ...
  <!-- DE Verarbeite alle Tags per User-Templates -->
  <!-- EN Match all user defined templates for SiteProxy -->
  <xsl:template match="cms:contentPanel[@id = 'siteProxyItemXML']">
