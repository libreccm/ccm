...
<xsl:stylesheet   xmlns:xsl="http://www.w3.org/1999/XSL/Transform" 
  ...
  <!-- DE Listenansicht -->
  <!-- EN List view -->
  <xsl:template name="CT_Organization_List" match="nav:item[nav:attribute[@name='objectType'] = 'com.arsdigita.cms.contenttypes.Organization']" mode="list_view">
    <xsl:call-template name="CT_GenericOrganizationalUnit_List"/>
  </xsl:template>

  <xsl:template name="CT_Organization_Link" match="nav:item[nav:attribute[@name='objectType'] = 'com.arsdigita.cms.contenttypes.Organization']" mode="link_view">
