...
-->
<!-- EN
  Processing FormBuilder items
  Each widget of html forms is processed by one template.
-->
...
<xsl:stylesheet 
  ...
  <!-- DE Listenansicht -->
  <!-- EN List view -->
  <xsl:template name="CT_Form_List" match="nav:item[nav:attribute[@name='objectType'] = 'com.arsdigita.cms.formbuilder.FormItem']" mode="list_view">
  ...
  <xsl:template name="CT_Form_Link" match="*/cms:item/links[targetItem/objectType = 'com.arsdigita.cms.formbuilder.FormItem']" mode="link_view">
