...
<!-- DE
  Hier wird das Portlet Webpage verarbeitet 
-->

<!-- EN
  Processing portlet webpage
-->
...
<xsl:stylesheet 
  ...
  <xsl:template match="bebop:portlet[@bebop:classname='com.arsdigita.cms.webpage.ui.WebpagePortletRenderer']" mode="setHeading">
    <xsl:variable name="setHeading">
      <xsl:call-template name="mandalay:getSetting">
        <xsl:with-param name="module" select="'portletWebpage'"/>
