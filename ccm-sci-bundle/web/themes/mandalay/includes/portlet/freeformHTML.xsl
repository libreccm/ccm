...
<!-- DE
  Hier wird das Portlet FreeformHTML verarbeitet 
-->

<!-- EN
  Processing portlet freeformHTML
-->
...
<xsl:stylesheet 
  ...
  <xsl:template match="portlet:freeformHTML" mode="setHeading">
    <xsl:variable name="setHeading">
      <xsl:call-template name="mandalay:getSetting">
        <xsl:with-param name="module" select="'portletFreeformHTML'"/>
