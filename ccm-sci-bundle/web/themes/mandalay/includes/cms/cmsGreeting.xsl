...
<!-- DE
  Hier wird das cmsGreeting verarbeitet 
-->

<!-- EN
  Processing cmsGreeting
-->
...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:template name="mandalay:cmsGreeting">
    <xsl:param name="resultTree"/>

    <div class="cmsGreeting">
      <xsl:call-template name="mandalay:getStaticText">
        <xsl:with-param name="module" select="'cms'"/>
        <xsl:with-param name="id" select="'greeting'"/>
      </xsl:call-template>
      &nbsp;
