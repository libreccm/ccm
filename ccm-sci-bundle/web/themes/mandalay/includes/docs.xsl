...
<xsl:stylesheet 
  ...
  <xsl:import href="docs/docsBody.xsl"/>
  <xsl:import href="docs/docsErrorLabel.xsl"/>
  <xsl:import href="docs/docsFileInfo.xsl"/>
  <xsl:import href="docs/docsFooter.xsl"/>
  <xsl:import href="docs/docsGlobal.xsl"/>
  <xsl:import href="docs/docsHeader.xsl"/>
  <xsl:import href="docs/docsItem.xsl"/>
