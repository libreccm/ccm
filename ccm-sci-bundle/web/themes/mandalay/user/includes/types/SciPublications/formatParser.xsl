...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" 
    ...
    <xsl:template name="bibrefCollectedVolume"
        ...
        <xsl:apply-templates>
            ...
            <xsl:with-param name="misc" select="$misc" />
            <xsl:with-param name="numberOfVolumes"
                            select="$numberOfVolumes" />
    ...
    <xsl:template name="bibrefJournal" match="bibrefJournalFormat">
        <!-- publication data -->
        <xsl:param name="issn" />
        <xsl:param name="misc" select="''" />
        <xsl:param name="reviewed" />
    ...
    <xsl:template name="bibrefMonograph"
        ...
        <xsl:apply-templates>
            ...
            <xsl:with-param name="reviewed" select="$reviewed" />
            <xsl:with-param name="series" select="$series" />
            <xsl:with-param name="seriesVolume" select="$seriesVolume" />
            <xsl:with-param name="title" select="$title" />
            <xsl:with-param name="volume" select="$volume" />
            <xsl:with-param name="year" select="$year" />
            <!-- technical data -->
    ...
    <xsl:template name="bibrefMovie"
                  match="bibrefMovieFormat">
        <!-- publication data -->
        <xsl:param name="authors" />
        ...
        <xsl:param name="organization" />
        <xsl:param name="place" />
        <xsl:param name="productionCompany" />
        <xsl:param name="series" />
        <xsl:param name="title" />
        <xsl:param name="year" />
        <!-- technical data -->
        ...
        <xsl:apply-templates>
            ...
            <xsl:with-param name="organization" select="$organization" />
            <xsl:with-param name="place" select="$place" />
            <xsl:with-param name="productionCompany" select="$productionCompany"/>
            <xsl:with-param name="series" select="$series" />
            <xsl:with-param name="title" select="$title" />
            <xsl:with-param name="year" select="$year" />
            <!-- technical data -->
    ...
    <xsl:template name="bibrefPlay"
                  match="bibrefPlayFormat">
        <!-- publication data -->
        <xsl:param name="authors" />
        <xsl:param name="edition" />
        <xsl:param name="firstProductionTheatre"/>
        <xsl:param name="firstProductionYear"/>
        <xsl:param name="isbn" />
        <xsl:param name="misc" select="''" />
        <xsl:param name="numberOfPages" />
        <xsl:param name="numberOfVolumes" />
        ...
        <xsl:apply-templates>
            ...
            <xsl:with-param name="authors" select="$authors" />
            <xsl:with-param name="edition" select="$edition" />
            <xsl:with-param name="firstProductionTheatre" select="$firstProductionTheatre"/>
    ...
    <xsl:template name="bibrefProceedings"
        ...
        <xsl:apply-templates>
            <!-- publication data -->
            <xsl:with-param name="authors" select="$authors"/>
            <xsl:with-param name="dateFromOfConference"
                            select="$dateFromOfConference" />
            <xsl:with-param name="dateToOfConference"
                            select="$dateToOfConference" />
            <xsl:with-param name="isbn" select="$isbn" />
            <xsl:with-param name="misc" select="$misc" />
            <xsl:with-param name="nameOfConference"
                            select="$nameOfConference" />
            <xsl:with-param name="numberOfVolumes"
                            select="$numberOfVolumes" />
            <xsl:with-param name="numberOfPages"
                            select="$numberOfPages" />
            <xsl:with-param name="organizerOfConference"
                            select="$organizerOfConference" />
            <xsl:with-param name="placeOfConference"
                            select="$placeOfConference" />
            <xsl:with-param name="publisher" select="$publisher" />
            <xsl:with-param name="series" select="$series" />
            <xsl:with-param name="title" select="$title" />
            <xsl:with-param name="volume" select="$volume" />
    ...
    <xsl:template name="bibrefReview" match="bibrefReviewFormat">
        <!-- publication data -->
        <xsl:param name="authors" />
        <xsl:param name="issue" />
        <xsl:param name="journal" />
    ...
    <!-- Process format definition for research report-->
    <xsl:template name="bibrefResearchReport"
                  match="bibrefResearchReportFormat">
        <!-- publication data -->
        <xsl:param name="authors" />
        <xsl:param name="misc" />
        <xsl:param name="number" />
        ...
        <xsl:choose>
            <xsl:when test="string-length(normalize-space($collectedVolume)) &gt; 1">
                <span class="publicationCollectedVolumeInfo">
                    ...
                    <span class="publicationCollectedVolume">
                        <xsl:value-of select="normalize-space($collectedVolume)" />
                    </span>
                    <xsl:if test="./@postText">
                        <span class="postText">
                            <xsl:call-template name="mandalay:getStaticText">
    ...
    <!-- Process the symbol of a journal -->
    <xsl:template match="bibrefFormat/bibrefJournalFormat/symbol | bibrefFormat/structDefs/symbol">
        <xsl:param name="symbol" />
    ...
    <xsl:template match="bibrefFormat//director">
        <xsl:param name="director" />
        <xsl:choose>
            <xsl:when test="string-length($director) &gt; 0">
                <span class="publicationDirectorInfo">
                    <xsl:if test="./@before">
                        <span class="before">
                            <xsl:value-of select="./@before" />
                        </span>
                    </xsl:if>
                    <span class="publicationDirector">
    ...
    <xsl:template match="bibrefFormat//firstProductionTheatre">
        <xsl:param name="firstProductionTheatre" />
        <xsl:choose>
            <xsl:when test="string-length($firstProductionTheatre) &gt; 0">
                <span class="publicationFirstProductionTheatreInfo">
                    <xsl:if test="./@before">
                        <span class="before">
                            <xsl:value-of select="./@before" />
                        </span>
                    ...
                    <span class="publicationFirstProductionTheatre">
                        <xsl:value-of select="$firstProductionTheatre" />
                    </span>
                    <xsl:if test="./@postText">
                        <span class="postText">
                            <xsl:call-template name="mandalay:getStaticText">
    ...
    <xsl:template match="bibrefFormat//firstProductionYear">
        <xsl:param name="firstProductionYear" />
        <xsl:choose>
            <xsl:when test="string-length($firstProductionYear) &gt; 0">
                <span class="publicationFirstProductionYearInfo">
                    <xsl:if test="./@before">
                        <span class="before">
                            <xsl:value-of select="./@before" />
                        </span>
                    ...
                    <span class="publicationFirstProductionYear">
        ...
        <xsl:choose>
            <xsl:when test="string-length($lastAccessed) &gt; 0">
                <span class="lastAccessedInfo">
                    ...
                    <span class="lastAccessed">
                        <xsl:value-of select="$lastAccessed" />
                    </span>
                    <xsl:if test="./@postText">
                        <span class="preText">
                            <xsl:call-template name="mandalay:getStaticText">
        ...
        <xsl:choose>
            <xsl:when test="string-length(normalize-space($misc)) &gt; 1">
                ...
                <span class="publicationMiscInfo">
                    ...
                    <span class="publicationMisc">
                        <xsl:value-of select="normalize-space($misc)" />
                    </span>
                    <xsl:if test="./@postText = 'true'">
                        <span class="postText">
                            <xsl:call-template name="mandalay:getStaticText">
        ...
        <xsl:choose>
            <xsl:when test="string-length($numberOfPages) &gt; 0">
                <span class="publicationNumberOfPagesInfo">
                    ...
                    <span class="publicationNumberOfPages">
                        <xsl:value-of select="normalize-space($numberOfPages)" />
                    </span>
                    <xsl:if test="./@postText = 'true'">
                        <span class="postText">
                            <xsl:call-template name="mandalay:getStaticText">
        ...
        <xsl:choose>
            <xsl:when test="string-length($numberOfVolumes) &gt; 0">
                <span class="publicationNumberOfVolumesInfo">
                    ...
                    <span class="publicationNumberOfVolumes">
        ...
        <xsl:choose>
            <xsl:when test="string-length($organization) &gt; 0">
                <span class="publicationOrganizationInfo">
                    ...
                    <span class="publicationOrganization">
        ...
        <xsl:choose>
            <xsl:when test="string-length($organizerOfConference) &gt; 0">
                ...
                <span class="publicationProceedingsOrganizerOfConferenceInfo">
                    ...
                    <span class="publicationInProceedingsOrganizerOfConference">

                        <xsl:value-of select="$organizerOfConference" />
                    </span>
                    <xsl:if test="./@postText">
                        <xsl:call-template name="mandalay:getStaticText">
                            <xsl:with-param name="module"
            ...
            <xsl:otherwise>
                <xsl:if test="./@ifEmpty">
                    <span class="publicationOrganizerOfConferenceInfo">
                        <span class="ifEmpty">
                            <xsl:value-of select="./@ifEmpty" />
                        </span>
                    </span>
        ...
        <xsl:choose>
            <xsl:when test="(string-length($pagesFrom) &gt; 0)">
                <span class="publicationPagesInfo">
                    ...
                    <span class="publicationPagesFrom">
                        <xsl:value-of select="normalize-space($pagesFrom)" />
                    </span>
                    <xsl:if test="string-length($pagesTo) &gt; 0">
                        ...
                        <span class="publicationPagesTo">
                            <xsl:value-of select="normalize-space($pagesTo)" />
                        </span>
                    </xsl:if>
                    <xsl:if test="./@postText">
                        <span class="postText">
        ...
        <xsl:choose>
            <xsl:when test="string-length($placeOfConference) &gt; 0">
                <span class="publicationProceedingsPlaceOfConferenceInfo">
                    ...
                    <span class="publicationProceedingsPlaceOfConference">
        ...
        <xsl:choose>
            <xsl:when test="string-length($proceedings) &gt; 0">
                <span class="publicationProceedingsInfo">
                    ...
                    <span class="publicationProceedings">
                        <xsl:value-of select="$proceedings" />
                    </span>
                    <xsl:if test="./@postText = 'true'">
                        <span class="postText">
                            <xsl:call-template name="mandalay:getStaticText">
    ...
    <!-- Procsses the organization info -->
    <xsl:template match="bibrefFormat//productionCompany">
        <xsl:param name="productionCompany" />
        <xsl:choose>
            <xsl:when test="string-length($productionCompany) &gt; 0">
                <span class="publicationProductionCompanyInfo">
                    <xsl:if test="./@before">
                        <span class="before">
                            <xsl:value-of select="./@before" />
                        </span>
                    ...
                    <span class="publicationProductionCompany">
        ...
        <xsl:choose>
            <xsl:when test="string-length($publisher) &gt; 0">
                <span class="publicationPublisherInfo">
                    ...
                    <span class="publicationPublisher">
    ...
    <xsl:template match="bibrefFormat//series">
        <xsl:param name="series" />
        <xsl:param name="seriesVolume" select="''"/>
        <xsl:choose>
            <xsl:when test="string-length($series)&gt; 0">
                <span class="publicationSeriesInfo">
                    ...
                    <xsl:if test="string-length($seriesVolume) &gt; 0">
                        <xsl:call-template name="mandalay:getStaticText">
                            <xsl:with-param name="module" select="'SciPublications'" />
                            <xsl:with-param name="id" select="./@numberText"/>
                        </xsl:call-template>
                        <xsl:value-of select="$seriesVolume"/>
                    </xsl:if>
                </span>
            </xsl:when>
            <xsl:otherwise>
                <xsl:if test="./@ifEmpty">
                    <span class="publicationSerieseInfo">
                        <span class="ifEmpty">
                            <xsl:value-of select="./@ifEmpty" />
                        </span>
                    </span>
    ...
    <xsl:template match="bibrefFormat//title">
        ...
        <xsl:variable name="setDetailLink">
            <xsl:call-template name="mandalay:getSetting">
                <xsl:with-param name="module"
                                select="'SciPublications_PublicationList'" />
    ...
    -->
    <xsl:template name="bibrefAuthor" match="bibrefAuthorFormat">
    ...
    <xsl:template match="bibrefPublisherFormat/name">
        ...
        <xsl:if test="string-length($name) &gt; 0">
            <span class="publicationPublisherNameInfo">
                ...
                <span class="publicationPublisherName">
    ...
    <xsl:template match="bibrefFormat//struct">
        ...
        <xsl:variable name="structData">
            <xsl:apply-templates select="../../structDefs/structDef[@name=$structName]/*">
                ...
                <xsl:with-param name="issue" select="$issue" />
                <xsl:with-param name="journal" select="$journal" />
                <xsl:with-param name="lastAccessed"
                                select="$lastAccessed" />
                <xsl:with-param name="misc" select="$misc" />
                <xsl:with-param name="nameOfConference"
                                select="$nameOfConference" />
        ...
        <xsl:variable name="minLength">
            <xsl:choose>
                <xsl:when test="string-length(./@minLength) &gt; 0">
        ...
        <xsl:choose>
            <xsl:when test="string-length(normalize-space($structData)) &gt; $minLength">
                ...
                <span class="publicationDataStructInfo">
                    ...
                    <span class="publicationDataStruct">
                        <xsl:value-of select="$structData" />
                    </span>
                    <xsl:if test="./@postText = 'true'">
                        <span class="postText">
                            <xsl:call-template name="mandalay:getStaticText">
