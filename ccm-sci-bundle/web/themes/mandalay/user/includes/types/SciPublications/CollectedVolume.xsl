...
<xsl:stylesheet
  ...
  -->
    <xsl:template name="CT_CollectedVolume_graphics"
		match="cms:item[objectType='com.arsdigita.cms.contenttypes.CollectedVolume']"
		mode="detailed_view">
  ...
  <!--
      ...
      =========
  -->
  <xsl:template match="publications[objectType='com.arsdigita.cms.contenttypes.CollectedVolume']"
		mode="list_view">
  ...
  <xsl:template match="publication[objectType='com.arsdigita.cms.contenttypes.CollectedVolume']"
		mode="list_view">
    <xsl:param name="useRelativeUrl" select="'false'"/>
    <xsl:call-template name="CT_CollectedVolume_List">
      <xsl:with-param name="useRelativeUrl" select="$useRelativeUrl"/>
  ...
  <xsl:template 
    name="CT_CollectedVolume_List" 
    match="nav:item[nav:attribute[@name='objectType'] = 'com.arsdigita.cms.contenttypes.CollectedVolume']"
    mode="list_view">
    <xsl:param name="useRelativeUrl" select="'false'"/>
    <xsl:variable name="formatDefFile">
      <xsl:call-template name="mandalay:getSetting">
  ...
  <!-- Link view -->
  <xsl:template 
    name="CT_CollectedVolume_Link" 
    match="*/cms:item/links[targetItem/objectType = 'com.arsdigita.cms.contenttypes.CollectedVolume']"
    mode="link_view">
