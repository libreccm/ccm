...
<xsl:stylesheet
  ...
  <!-- 
       ...
       ===========
  -->
    <xsl:template name="CT_InProceedings_graphics"
		match="cms:item[objectType='com.arsdigita.cms.contenttypes.InProceedings']"
		mode="detailed_view">
	...
	<xsl:if test="($setProceedings = 'true') and (count(./proceedings) &gt; 0)">
	  ...
	  <dd>
	    <a>
	      <xsl:attribute name="href">/redirect/?oid=<xsl:value-of select="./proceedings/@oid"/></xsl:attribute>
  ...
  <!--
      ...
      =========
  -->
  <xsl:template match="publications[objectType='com.arsdigita.cms.contenttypes.InProceedings']"
		mode="list_view">
  ...
  <xsl:template match="publication[objectType='com.arsdigita.cms.contenttypes.InProceedings']"
		mode="list_view">
    <xsl:param name="useRelativeUrl" select="'false'"/>
    <xsl:call-template name="CT_InProceedings_List">
      <xsl:with-param name="useRelativeUrl" select="$useRelativeUrl"/>
  ...
  <xsl:template 
    name="CT_InProceedings_List" 
    match="nav:item[nav:attribute[@name='objectType'] = 'com.arsdigita.cms.contenttypes.InProceedings']"
    mode="list_view">
    <xsl:param name="useRelativeUrl" select="'false'"/>
  ...
  <!-- Link view -->
  <xsl:template 
    name="CT_InProceedings_Link" 
    match="*/cms:item/links[targetItem/objectType = 'com.arsdigita.cms.contenttypes.InProceedings']"
    mode="link_view">
