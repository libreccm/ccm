...
<xsl:stylesheet
  ...
  <!-- 
       ...
       ===========
  -->
    <xsl:template name="CT_GreyLiterature_graphics"
		match="cms:item[objectType='com.arsdigita.cms.contenttypes.GreyLiterature']"
		mode="detailed_view">
  ...
  <xsl:template match="publications[objectType='com.arsdigita.cms.contenttypes.GreyLiterature']"
		mode="list_view">
  ...
  <xsl:template match="publication[objectType='com.arsdigita.cms.contenttypes.GreyLiterature']"
		mode="list_view">
    <xsl:param name="useRelativeUrl" select="'false'"/>
    <xsl:call-template name="CT_GreyLiterature_List">
      <xsl:with-param name="useRelativeUrl" select="$useRelativeUrl"/>
  ...
  <xsl:template 
    name="CT_GreyLiterature_List" 
    match="nav:item[nav:attribute[@name='objectType'] = 'com.arsdigita.cms.contenttypes.GreyLiterature']"
    mode="list_view">
    <xsl:param name="useRelativeUrl" select="'false'"/>
  ...
  <!-- Link view -->
  <xsl:template 
    name="CT_GreyLiterature_Link" 
    match="*/cms:item/links[targetItem/objectType = 'com.arsdigita.cms.contenttypes.GreyLiterature']"
    mode="link_view">
