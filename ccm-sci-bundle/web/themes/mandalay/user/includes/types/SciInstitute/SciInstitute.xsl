...
<xsl:stylesheet
  ...
  <!--
      ******************************************************
      ** Template for the detail view of a SciInstitute **
      *****************************************************
  -->
  ...
  <xsl:template name="CT_SciInstitute_graphics"
	...
	<xsl:for-each select="./orgaUnitTabs/availableTabs/availableTab">
	  <li>
		...
		<xsl:value-of select="$subNavSeparator"/>
	      </xsl:if> -->
	    </a>
	  </li>
	</xsl:for-each>
  ...
  <!-- DE Listenansicht -->
  <!-- EN List view -->
  <xsl:template  name="CT_SciInstitute_List" match="nav:item[nav:attribute[@name='objectType'] = 'com.arsdigita.cms.contenttypes.SciInstitute']" mode="list_view">
  ...
  <xsl:template name="CT_SciInstitute_Link" match="*/cms:item/links[targetItem/objectType = 'com.arsdigita.cms.contenttypes.SciInstitute']" mode="link_view">
