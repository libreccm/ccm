...
<xsl:stylesheet 
  ...
  xmlns:theme="http://ccm.redhat.com/theme/1.0"
  exclude-result-prefixes="xsl bebop cms nav mandalay theme" 
  version="1.0">
  
  <xsl:import href="theme/themeErrorInfo.xsl"/>
  <xsl:import href="theme/themeFileList.xsl"/>
  <xsl:import href="theme/themeFolder.xsl"/>
  <xsl:import href="theme/themeFile.xsl"/>
