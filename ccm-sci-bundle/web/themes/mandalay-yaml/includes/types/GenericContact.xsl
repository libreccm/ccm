...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <!-- DE Listenansicht -->
  <!-- EN List view -->
  <xsl:template name="CT_GenericContact_List"
    match="nav:item[nav:attribute[@name='objectType'] = 'com.arsdigita.cms.contenttypes.GenericContact']"
    mode="list_view">
  ...
  <xsl:template name="CT_GenericContact_Link" match="*/cms:item/links[targetItem/objectType = 'com.arsdigita.cms.contenttypes.GenericContact']" mode="link_view">
