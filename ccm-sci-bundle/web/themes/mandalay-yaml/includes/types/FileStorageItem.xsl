...
<xsl:stylesheet 
  ...
  <xsl:template name="CT_FileStorageItem_graphics" match="cms:item[objectType='com.arsdigita.cms.contenttypes.FileStorageItem']" mode="detailed_view">
    ...
    <xsl:variable name="setViewLink">
      <xsl:call-template name="mandalay:getSetting">
        <xsl:with-param name="module"  select="'FileStorageItem'"/>
        <xsl:with-param name="setting" select="'setViewLink'"/>
        <xsl:with-param name="default" select="'true'"/>
      </xsl:call-template>
    </xsl:variable>
    <xsl:variable name="setSaveLink">
      <xsl:call-template name="mandalay:getSetting">
        <xsl:with-param name="module"  select="'FileStorageItem'"/>
        <xsl:with-param name="setting" select="'setSaveLink'"/>
        <xsl:with-param name="default" select="'true'"/>
      </xsl:call-template>
    </xsl:variable>
  ...
  <!-- DE Listenansicht -->
  <!-- EN List view -->
  <xsl:template name="CT_FileStorageItem_List" match="nav:item[nav:attribute[@name='objectType'] = 'com.arsdigita.cms.contenttypes.FileStorageItem']" mode="list_view">
    ...
    <xsl:variable name="setDescription">
      <xsl:call-template name="mandalay:getSetting">
        <xsl:with-param name="module"  select="'FileStorageItem'"/>
        <xsl:with-param name="setting" select="'listView/setDescription'"/>
        <xsl:with-param name="default" select="'true'"/>
      </xsl:call-template>
    </xsl:variable>
    <xsl:variable name="setDescriptionLength">
      <xsl:call-template name="mandalay:getSetting">
        <xsl:with-param name="module"  select="'FileStorageItem'"/>
        <xsl:with-param name="setting" select="'listView/setDescriptionLength'"/>
    ...
    <xsl:if test="nav:attribute[@name='description'] and $setDescription = 'true'">
      <br />
      <span class="intro">
        <xsl:choose>
  ...
  <xsl:template name="CT_FileStorageItem_Link" match="*/cms:item/links[targetItem/objectType = 'com.arsdigita.cms.contenttypes.FileStorageItem']" mode="link_view">
