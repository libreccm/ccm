...
<!-- DE
  Hier wird das Portlet Flash verarbeitet 
-->

<!-- EN
  Processing portlet flash
-->
...
<xsl:stylesheet 
  ...
  <xsl:template match="portlet:flash" mode="setHeading">
    <xsl:variable name="setHeading">
      <xsl:call-template name="mandalay:getSetting">
        <xsl:with-param name="module" select="'portletFlash'"/>
