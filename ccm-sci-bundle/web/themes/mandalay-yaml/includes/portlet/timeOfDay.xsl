...
<!-- DE
  Hier weird das Portlet TimeOfDay verarbeitet 
-->

<!-- EN
  Processing portlet timeOfDay
-->
...
<xsl:stylesheet 
  ...
  <xsl:template match="portlet:timeOfDay" mode="setHeading">
    <xsl:variable name="setHeading">
      <xsl:call-template name="mandalay:getSetting">
        <xsl:with-param name="module" select="'portletContentItem'"/>
