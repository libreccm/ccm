...
public class SubmitForm extends WidgetForm {
    private TextField m_value;

    public SubmitForm(String name,
    ...
    protected void addWidgets(FormSection section) {
        ...
        m_value.addValidationListener(new StringInRangeValidationListener(1, 50));
        section.add(new Label(GlobalizationUtil.globalize("formbuilder.ui.editors.label")), ColumnPanel.RIGHT);
        section.add(m_value);

        m_value.setOnFocus("if (this.form." + NAME + ".value == '') { " +
        ...
        automaticallySetName(m_value.getParameterModel());
    }

    protected PersistentWidget getWidget() {
        return new PersistentSubmit();
    }

    protected PersistentWidget getWidget(BigDecimal id)
        throws DataObjectNotFoundException {

        return new PersistentSubmit(id);
    }
    ...
    protected void initWidgets(FormSectionEvent e,
        ...
        PersistentSubmit widget = (PersistentSubmit)w;
