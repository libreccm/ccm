...
public class MultipleSelectForm extends OptionGroupForm {
    public MultipleSelectForm(String name,
    ...
    protected OptionGroup getOptionGroup(String name) {
        return new MultipleSelect(name);
    }

    protected PersistentWidget getWidget() {
        return new PersistentMultipleSelect();
    }
