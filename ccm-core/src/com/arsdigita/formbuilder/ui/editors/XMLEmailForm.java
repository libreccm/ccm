...
import com.arsdigita.formbuilder.actions.XMLEmailListener;
...
public class XMLEmailForm extends ProcessListenerForm {

    private TextField m_to;
    private TextField m_subject;

    public XMLEmailForm(String name,
    ...
    protected void initWidgets(FormSectionEvent e,
        ...
        XMLEmailListener l = (XMLEmailListener)listener;
