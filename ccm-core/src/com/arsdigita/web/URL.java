...
public class URL {
    ...
    /**
     * <p>Returns the scheme (sometimes called the protocol) of the
     * URL.  Examples are <code>"http"</code> and
     * <code>"https"</code>.</p>
     *
    ...
    /**
     * <p>Returns the domain name part of the URL.  For instance,
     * <code>"ccm.redhat.com"</code>.</p>
     *
     * @see javax.servlet.ServletRequest#getServerName()
     * @return a <code>String</code> representing the URL's server
     * name
     */
    ...
    /**
     * <p>Returns the port number of the URL.  <code>8080</code>, for
     * example.</p>
     *
    ...
    /**
     * <p>Returns the server half of the URL, as opposed to the "file"
 ...
 getPathInfo()</code>.</p>
    ...
    /**
     * <p>Returns the values for a parameter.  If the URL was
     * constructed with a null <code>ParameterMap</code>, this method
     * returns null.</p>
     *
     * @see
    ...
    /**
     * <p>Returns an immutable map of the query parameters.  The map's
     * keys are <code>String</code>s and the map's values are
     * <code>String[]</code>s.  If the URL was constructed with a null
     * <code>ParameterMap</code>, this method returns null.</p>
     *
    ...
    /**
     * <p>Creates a URL to the site's root path.  For example,
    ...
    /**
     * <p>Creates a URL using the elements of the user's original
     * request but with the given set of parameters instead of the
     * original ones.</p>
     *
    ...
    /**
     * <p>Creates a URL with local parameters.</p>
     *
    ...
    /**
     * <p>Create a URL with local parameters to <code>pathInfo</code> under the
