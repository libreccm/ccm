...
--
-- $Id: table-site_nodes-auto.sql 287 2005-02-22 00:29:02Z sskracic $
-- $DateTime: 2004/08/16 18:10:38 $
create table site_nodes (
    node_id INTEGER not null
        constraint site_nodes_node_id_p_omovr
          primary key,
    ...
    parent_id INTEGER,
        -- referential constraint for parent_id deferred due to circular dependencies
    pattern_p BOOLEAN not null,
    url VARCHAR(3000),
