 ...
 * its subclasses). The attributes edited are 'name', 'title', 'minute number',
 * 'description', 'actuib item', 'attendees', 'description of minutes'. This
 * authoring step replaces the <code>com.arsdigita.ui.authoring.PageEdit</code>
 * step for this type.
 **/
public class MinutesPropertiesStep extends SimpleEditStep {

    /** The name of the editing sheet added to this step */
    public static String EDIT_SHEET_NAME = "edit";

    public MinutesPropertiesStep(ItemSelectionModel itemModel,
    ...
    /**
     * Returns a component that displays the properties of the Minutes specified
     ...
     *  of the release
     **/
    public static Component getMinutesPropertySheet(ItemSelectionModel
                                                    itemModel) {
