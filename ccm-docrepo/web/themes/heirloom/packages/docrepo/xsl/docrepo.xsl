...
<!--  <link href="/css/acs-master.css" rel="stylesheet" type="text/css"/> -->
       <!-- docrepo.css had been copied from portalserver.css  -->
       <link href="{$internal-theme}/css/docrepo.css"
...
<!-- Table with alternate color for each column. -->
 ...
 <xsl:template match="docs:file-info" 
               xmlns:docs="http://www.arsdigita.com/docs-ui/1.0">
   <table>
     <tr>
       <td>Name:</td>
     ...
     <tr>
       <td>URI:</td>
       <td><xsl:value-of select="docs:uri"/></td>
     </tr>
...
<!--
            <td class="global-link-icon">
             <a href="/assets/help/toc_main.html">
              <img src="{$internal-theme}/images/lifesaver.png" height="18" width="21"/>
             </a>
            </td>
            <td class="global-link">
             <a href="/assets/help/toc_main.html">Help
             </a>
            </td>
-->
            <td class="global-link-icon">
