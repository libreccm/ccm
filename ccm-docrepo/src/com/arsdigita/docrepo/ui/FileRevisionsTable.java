        ...
        public Component getComponent(Table table,
            ...
            if (value != null) {
                ...
                Link link = new Link("Download",
                                     "download/?" +
                                     FILE_ID_PARAM.getName() + "=" + file.getID() + "&trans_id=" + key);
...
class FileRevisionsTableModel implements TableModel, DRConstants {
    ...
    public Object getElementAt(int columnIndex) {
        switch (columnIndex) {
            ...
            case 2:
                if(m_row == 0)
                 return DRUtils.DateFormat.format(m_file.getCreationDate());
                else
                 return DRUtils.DateFormat.format(m_file.getLastModifiedDate());
            case 3: {
