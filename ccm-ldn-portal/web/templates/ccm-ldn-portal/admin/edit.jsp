<jsp:root xmlns:jsp="http://java.sun.com/JSP/Page"
    ...
    <jsp:directive.page import="com.arsdigita.london.portal.ui.admin.PeoplePane"/>
    ...
    <define:page name="adminPage" application="portal" title="Workspace Admin" cache="true">
      ...
      <define:component name="admin" classname="com.arsdigita.london.portal.ui.admin.PeoplePane" />
