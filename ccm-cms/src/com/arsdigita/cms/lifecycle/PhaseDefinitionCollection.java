 ...
 * @version $Id: PhaseDefinitionCollection.java 2090 2010-04-17 08:04:14Z pboy $
 */
public class PhaseDefinitionCollection extends DomainCollection {
     ...
     *
     */
    public PhaseDefinitionCollection(DataCollection dataCollection) {
    ...
    public DomainObject getDomainObject() {
        return new PhaseDefinition(m_dataCollection.getDataObject());
    }

    /**
     * Returns a <code>PhaseDefinition</code> for the current position in
     * the collection.
     *
     */
    public PhaseDefinition getPhaseDefinition() {
        return (PhaseDefinition) getDomainObject();
    }
